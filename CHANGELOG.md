...
- Rules apply to the current filtered results and can be combined in sequence.
- Published an updated executable containing the rule-processing features.

## v0.1.0 - 2026-08-07

- Initial public release of the Windows batch file renaming utility.
